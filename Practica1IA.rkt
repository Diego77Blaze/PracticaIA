...
;(car(cdr(cdr(listaConstruir3PrimerasFilas board 0))))
;(listaConstruir3FilasDelMedio board 3);(listaConstruir3UltimasFilas board 6)
;(define(construirPrimerCuadrante board)(list (list-ref (car(listaConstruir3UltimasFilas board 6))0) (list-ref (car(listaConstruir3UltimasFilas board 6))1) (list-ref (car(listaConstruir3UltimasFilas board 6))2) (list-ref (car(listaConstruir3UltimasFilas board 7))0) (list-ref (car(listaConstruir3UltimasFilas board 7))1) (list-ref (car(listaConstruir3PrimerasFilas board 7))2) (list-ref (car(listaConstruir3PrimerasFilas board 8))0) (list-ref (car(listaConstruir3PrimerasFilas board 8))1) (list-ref (car(listaConstruir3PrimerasFilas board 8))2)))
